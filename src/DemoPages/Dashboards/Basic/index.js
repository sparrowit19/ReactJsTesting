...
export default class AnalyticsDashboard1 extends Component {
   ...
   componentDidMount() {
      setInterval(function (_this) {
         var reports_generated = _this.state.reports_generated;
         reports_generated += 5;
         var profiles = _this.state.profiles;
         profiles += 5;
         var bug = _this.state.bug;
         bug += 5;
